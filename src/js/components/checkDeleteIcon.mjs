/**
 * Checks if name of logged in users profile is equal to name of creator of listing, and if not, removes delete listing icon.
 * @example
 * ```js
 * deleteIconCheck(profile, listing)
 * // Hides delete listing icon if name of logged in users profile is not equal to name of creator of listing.
 * ```
 */
export function deleteIconCheck(profile, listing) {
